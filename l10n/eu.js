OC.L10N.register(
    "sharepoint",
    {
    "Enforce NTLM auth" : "NTLM autentifikazioa aplikatu",
    "Acquiring a SAML token is attempted first by default." : "SAML token bat eskuratzen lehen modu lehenetsian saiatzen da.",
